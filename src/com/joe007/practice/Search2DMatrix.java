...
public class Search2DMatrix {
    ...
    // }
    // int middleIndex = -1;
    // while(beginIndex < endIndex && beginIndex != middleIndex && middleIndex
    // != endIndex){
    ...
    // }
    //
    // if(beginIndex < 0 || beginIndex > rowCount -1 || endIndex < 0 || endIndex
    // > rowCount - 1 ){
    // return false;
    // }
    // // System.out.println("---beginIndex :" + beginIndex + "; middleIndex:" +
    // middleIndex + "; endIndex :" + endIndex);
    // if(findTargetInArr(matrix[middleIndex], target) ||
    // findTargetInArr(matrix[beginIndex], target) ||
    // findTargetInArr(matrix[endIndex], target)){
    // return true;
    // }
    ...
    private boolean findTargetInArr(int[] arr, int target) {
        ...
        while (beginIndex < endIndex && beginIndex != middleIndex
            ...
            if (target < arr[middleIndex]) {
                ...
                //
                // System.out.println("====target==arr[middleIndex]:" +
        ...
        // System.out.println("beginIndex :" + beginIndex + "; middleIndex:" +
        // middleIndex + "; endIndex :" + endIndex);
        if (beginIndex < 0 || beginIndex > arr.length - 1 || endIndex < 0
                || endIndex > arr.length - 1) {
            return false;
        }
        return target == arr[endIndex] || target == arr[middleIndex]
                || target == arr[beginIndex];
    }
